#!/bin/sh
#err=HCA_ON/scripts/18_escape/1_opc_general_plot
err=HCA_ON/scripts/18_escape/1_opc_general_NSC_plot

#err=HCA_ON/scripts/18_escape/1_opc_general
mkdir $err
...
c="Astrocyte"
##########sh sb.sh -c HCA_ON/scripts/18_escape/1_opc_general.sh -e $err -j $c -m 50 -t 0-22 -p fg -- $name $c
