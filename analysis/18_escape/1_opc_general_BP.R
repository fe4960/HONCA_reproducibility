...
saveRDS(scRep_example,file=paste0(name, "_escape_BP.rds"))

library(ggplot2)
library(RColorBrewer)
pdf(paste0(name, "_escape_heatmap_BP.pdf"), width=12, height = 8)
...
pdf(paste0(name, "_escape_heatmap_norm_BP.pdf"), width=12, height = 8)
heatmapEnrichment(scRep_example,
                  group.by = "subclass",
...
pdf(paste0(name, "_escape_year_BP.pdf"))
RidgePlot(
  scRep_example,
  "age_year",
  group.by = "subclass",
