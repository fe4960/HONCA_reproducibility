...
scRep_example=readRDS(paste0(name, "_escape_NSC.rds"))

library(ggplot2)
library(RColorBrewer)
pdf(paste0(name, "_escape_heatmap_NSC.pdf"), width=6, height = 5)
...
pdf(paste0(name, "_escape_heatmap_norm_NSC.pdf"), width=6, height = 5)
heatmapEnrichment(scRep_example,
                  group.by = "subclass",
