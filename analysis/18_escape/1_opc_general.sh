...
R --vanilla --args $n < /dfs3b/ruic20_lab/junw42/HCA_ON/scripts/18_escape/1_opc_general.R  > /dfs3b/ruic20_lab/junw42/HCA_ON/scripts/18_escape/1_opc_general/${2}.out 2> /dfs3b/ruic20_lab/junw42/HCA_ON/scripts/18_escape/1_opc_general/${2}.err
