...
comd=${main}/HCA_ON/scripts/20_hotspot/3_hotspot_umap_from_JS
mkdir $comd
...
do
echo "$label"
#sh sb.sh -c ${comd}.sh -e $comd -j $label -m 150 -p fg -t 0-10 -- $dir $label $t
done

label="Oligodendrocyte_precursor_cell_fullcell_10kgene"
...
#hvg="hvg_10000"
t="scvi"
#sh sb.sh -c ${comd}.sh -e $comd -j $label -m 30 -p s -t 0-10 -- $dir $label $t $hvg


#label="Astrocyte"
label="Oligodendrocyte_fullcell_5kgene"
hvg="hvg_5000"
#hvg="hvg_10000"
t="scvi"
#sh sb.sh -c ${comd}.sh -e $comd -j $label -m 100 -p fg -t 0-10 -- $dir $label $t $hvg
