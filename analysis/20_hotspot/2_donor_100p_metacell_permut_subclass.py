...
for cl in adata.obs[m].unique():

    meta_exprs = []
    meta_obs = []
    meta_dn = []
    meta_age = []
    adata1=adata[adata.obs[m]==cl]
    for dn in adata1.obs[t].unique():
        adata_t=adata1[adata1.obs[t]==dn]
...
#meta_adata.write("meta_cells_100.h5ad")
    ...
    meta_adata.write(f"{h5ad}_leiden_{cl}_permute_metacell_{n}.h5ad")
