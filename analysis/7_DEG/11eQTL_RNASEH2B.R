...
#    fn <- paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/major_majorclass_sample/exp_",ct,"_logNorm_all")
    fn <- paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/major_majorclass_sample/exp_",ct,"_Norm_all")
...
#, label.y=0
pdf("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/RNASEH2B_DEG_CPM.pdf", width=7.6, height=6)

#pdf("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/RNASEH2B_DEG.pdf", width=7, height=6)
print(p)
dev.off()

write.table(df, file="/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/RNASEH2B_DEG_CPM_demo", sep="\t", quote=F)
