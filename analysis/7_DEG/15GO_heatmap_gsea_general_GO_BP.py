...
od=sys.argv[4]
label=sys.argv[5]
fn2=f"/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/{od}/ct_list_{label}"
...
mol=["GO_Biological_Process_2023"]
dem=sys.argv[2]
#t=["up","down"]
t=["down"]
#t=["up"]
...
#    cell1["up"]={}
    ...
    for c in cell:
        for t1 in t:
            fn=f'/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/{od}/{ct}_subclass_DEG/{ct}/{c}_DEG_GO_age_{t1}/enrichr_{m}.txt'
    ...
    for l in go:
        fn=f'/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/{od}/{ct}_subclass_DEG/{ct}/{ct}_GO_top{n}_{m}_{dem}_{l}'  # msigdbr top 10
        fn2=f'/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/{od}/{ct}_subclass_DEG/{ct}/{ct}_GO_top{n}_{m}_{dem}_{l}_column'  # msigdbr top 10
...
#        if l == "down": 
        ...
        plt.title(f"{ct} GO_Biological_Process_2023 {dem} {l}")
