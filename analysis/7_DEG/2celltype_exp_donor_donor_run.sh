...
main="/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/genexp_donor_subclass_final_new"
...
for cell in  Astrocyte #Oligodendrocyte Fibroblast  Oligodendrocyte_precursor_cell     # Astrocyte Oligodendrocyte Oligodendrocyte_precursor_cell Endothelial_cell Fibroblast Microglia RGC MG  Macrophage #all #Endothelial_cell
do	
sample_list=${main}/snRNA_donor_num_${cell}
ct_list=${main}/ct_list_${cell}2
