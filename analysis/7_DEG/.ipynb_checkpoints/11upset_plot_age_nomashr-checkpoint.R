library(UpSetR)
cells=c("Fibroblast","Endothelial_cell","Astrocyte","Oligodendrocyte","all")
for(cell in cells){
file=paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/genexp_sample_subclass/",cell,"_subclass_DEG/",cell,"_upset_list_age_all_ct_nomashr_tab")
...
input=data$V2
names(input)=data$V1
pdf(paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/genexp_sample_subclass/",cell,"_subclass_DEG/",cell,"_upset_list_age_all_ct_nomashr.pdf"),width=10)
