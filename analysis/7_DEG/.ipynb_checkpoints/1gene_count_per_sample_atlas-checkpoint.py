...
list1=f"{main}/7_DEG/snRNA_sample_majorclass_num_atlas_cell"
...
for donor in adata.obs["sampleid"].value_counts().keys() :
		...
		genexp=grouped_obs_cpm(adata=adata_sub, group_key="majorclass1", layer="raw")
...
list=f"{main}/7_DEG/snRNA_sample_majorclass_num_atlas"
