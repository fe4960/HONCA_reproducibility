...
cell=pd.read_csv("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/ct_list_major", header=None) #["Rod","Cone","BC","RGC","MG","AC","HC"]
...
#		fn=f'/storage/chenlab/Users/junwang/human_meta/data/region_DESeq2_batch_region_dream/{c}_interval_cpm01_snRNA_rmH_FC1_young_cpm07_sim_rm0age_gender/{c}_{m}'
		fn=f"/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/major_majorclass_DEG/{c}/{c}_DEG_GO_{dem}/{c}_{m}_gse_{dem}"
...
#	fn=f'/storage/chenlab/Users/junwang/human_meta/data/region_DESeq2_batch_region_dream/GO_top15_gender_{l}'  # msigdbr top 10
		fn=f'/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/major_majorclass_DEG/GO_top{ct}_{m}_{dem}_{l}'  # msigdbr top 10
