...
dir1=f"{main}/7_DEG/genexp_major_donor_raw_atlas"
...
list1=f"{main}/7_DEG/snRNA_donor_majorclass_num_atlas_cell_final"
...
list=f"{main}/7_DEG/snRNA_donor_majorclass_num_atlas_final"
