...
#data=read.table(paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/",ct,"_majorclass_DEG/",cell,"/",cell,"_DEG_",dem),header=T,sep="\t")

data=read.table(paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/genexp_donor_subclass_final_new/",ct,"_subclass_DEG/", cell, "/", cell, "_DEG_age_cpm1"), header=T,sep="\t")
...
#geneList_up=rownames(data[(data$logFC>0)&(data$qval<0.01),])
#geneList_down=rownames(data[(data$logFC<0)&(data$qval<0.01),])
...
#dirIn=paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/",ct,"_majorclass_DEG/",cell,"/",cell,"_DEG_GO_",dem,"_up")
dirIn=paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/genexp_donor_subclass_final_new/",ct,"_subclass_DEG/", cell, "/", cell, "_DEG_age_cpm1_up")
...
dirIn=paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/genexp_donor_subclass_final_new/",ct,"_subclass_DEG/", cell, "/", cell, "_DEG_age_cpm1_down")

#dirIn=paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/",ct,"_majorclass_DEG/",cell,"/",cell,"_DEG_GO_",dem,"_down")
dir.create(dirIn,recursive = TRUE)
setwd(dirIn)
