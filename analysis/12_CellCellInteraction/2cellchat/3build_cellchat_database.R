...
dir="/dfs3b/ruic20_lab/junw42/reference/cellphonedb/cellphonedb-data/data/"

## load the database files
interaction_input <- read.csv(file = paste0(dir, '/interaction_input.csv'))
complex_input <- read.csv(file = paste0(dir, '/complex_input.csv'), row.names = 1)
geneInfo <- read.csv(file = paste0(dir, '/gene_input_uniq.csv'), row.names = 1)
...
save(db.new, file = paste0(dir,"CellChatDB.human_cellphonedb.rda"))
