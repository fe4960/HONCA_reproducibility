...
wd="HCA_ON/data/11_cellchat/nichenet/ONH_age_12_cellphoneDB_subclass1"
##wd=args[1]  #"/dfs3b/ruic20_lab/junw42/HCA_ON/data/11cellchat/major"
setwd(wd)
#####cc=read.table(args[2])
#####ct=args[3]
#####obj=readRDS(args[4])
#####obj=subset(obj, subset = !!sym(ct) %in% cc$V1)

#obj@meta.data$samples=obj@meta.data$sampleid
main1="/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/lattice_update/"
rds=paste0(main1, "ONONH_all_rawcount_subset_age0to12.rds")

seuratObj=readRDS(rds)

seuratObj@meta.data$celltype=seuratObj@meta.data$subclass1
...
lr_network = readRDS("/dfs3b/ruic20_lab/junw42/reference/nichenet/lr_network_human_21122021.rds")
ligand_target_matrix = readRDS("/dfs3b/ruic20_lab/junw42/reference/nichenet/ligand_target_matrix_nsga2r_final.rds")
weighted_networks = readRDS("/dfs3b/ruic20_lab/junw42/reference/nichenet/weighted_networks_nsga2r_final.rds")
...
receiver = "Oligodendrocyte_precursor_cell" #args[5]
...
sender_celltypes <- c("Astro_ONHON", "Astro_ONH1_GABBR2+SV2B+", "Astro_ONH2_PAX5+GABBR2+", "Endothelial_cell" , "Mural_cell", "Astro_retina", "Astro_ON", "Fibro_sclera", "Fibro_pia", "Fibro_dura", "Fibro_RPEchoroid_SMOC2+", "Fibro_RPEchoroid_BMP5+", "Fibro_perivascular")
...
seuratObj$aggregate = "No"

seuratObj@meta.data$aggregate[seuratObj@meta.data$celltype %in% c("Oligodendrocyte_precursor_cell", "OLIGO1", "OLIGO2_LRRC7+")] = "Yes"
...
#geneset_oi=c("BMP2", "BMP4", "BMP5", "BMP7", "BMP6", "BMP8A", "BMP8B", "BMP9", "BMP10", "BMP12", "BMP13", "BMP14", "BMP15", "BMP3", "BMP3B")
...
pdf("age0to12_opc_ligand_activity_heatmap.pdf")
...
pdf("age0to12_opc_heatmap.pdf", width=40,height=6)
...
pdf("age0to12_opc_ligand_receptor_interaction.pdf")
...
pdf("age0to12_opc_ligand_aupr_heatmap.pdf")
p_ligand_aupr
dev.off()
...
pdf("age0to12_opc_heatmap_ligand_target_sender_focus.pdf", width=30)
p_ligand_target
dev.off()
...
pdf("age0to12_opc_heatmap_ligand_receptor_sender_focus.pdf")
p_ligand_receptor
dev.off()
...
pdf("age0to12_opc_dotplot_ligand_receptor_sender_focus.pdf", width=30)
p_dotplot
dev.off()
...
#Idents(seuratObj)=seuratObj$aggregate
Idents(seuratObj)=seuratObj$aggregate
...
pdf("age0to12_opc_dotplot_sender_focus_lfc.pdf")
p_lfc
dev.off()

pdf("age0to12_opc_sender_focus_ligand_compare.pdf")
...
pdf("age0to12_opc_sender_focus_ligand_combined_plot.pdf")
combined_plot
dev.off()
