...
dir="/dfs3b/ruic20_lab/junw42/HCA_ON/data/12_snATAC/majorclass/" #$1 #"/storage/chenlab/Users/junwang/human_meta/data/proj4_clean1_final_major_full_max/PeakCalls/"
...
cell="g2p_cA_final_major_full_max_LCRE_uniq"
...
tail -n+2 ${dir}/${cell} | awk '{if(($1!="NA")&&($2!="NA")){print}}'  | cut -f 2 > ${dir}/${cell}_hg38

${main_dir}/software/liftOver -positions  ${dir}/${cell}_hg38  ${main_dir}/reference/ucsc_chain/hg38ToHg19.over.chain.gz  ${dir}/${cell}_hg38_hg19 ${dir}/${cell}_hg38_hg19_unmap
