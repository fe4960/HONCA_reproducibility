...
sc.pl.violin(adata,mk, groupby="majorclass", save=f"_TF_majorclass_nodot_{mk1}.pdf", jitter=False, rotation=90)
sc.pl.dotplot(adata, mk, groupby="majorclass", save=f"_TF_majorclass_{mk1}.pdf", swap_axes=True)
...
sc.pl.dotplot(adata, mk, groupby="subclass", save=f"_TF_astro_sub_class_{mk1}.pdf", swap_axes=True)
sc.pl.violin(adata,mk, groupby="subclass", save=f"_TF_astro_sub_class_nodot_{mk1}.pdf", jitter=False, rotation=90)
