#!/bin/sh
comd=HCA_ON/scripts/17_xenium/3harmony_cluster_coembed_indi_indi_prev_flt
mkdir $comd
...
do
echo $i
sh sb.sh -c ${comd}.sh -m 40 -p fg  -t 0-2 -e $comd -j ${label}_${i} -- $rds $meta $bc $label $ds $cut $f $sc $i
done
...
rds="/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Astrocyte/clean/Astrocyte_subclass_new4_clean_BCM_22_0047_ON_ONH_RNA_downsample.rds"
label=astro
bc="/dfs3b/ruic20_lab/junw42/HCA_ON/data/8_spatial/Xenium/20250620_PP_comb/ONONH_comb/ONONH_comb_xenium"
