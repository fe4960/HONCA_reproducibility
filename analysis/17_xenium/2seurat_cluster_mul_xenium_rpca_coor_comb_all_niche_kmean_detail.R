...
saveRDS(seu, file=paste0(output_PATH, target_tissue, "coembed.combined_inte_harmony_w1_harmony_anno_gap_stat_niches10_clean_merged.rds"))
...
pdf(paste0(output_PATH, target_tissue, "_all_annot_majorclass_heatmap_niche_kmean16_clean.pdf"), width=5, height=4)
print(p)
dev.off()
...
pdf(paste0(output_PATH, target_tissue, "_all_annot_majorclass_heatmap_niche_kmean6_clean.pdf"), width=5, height=3)
print(p)
dev.off()
...
pdf(paste0(output_PATH, target_tissue, "_all_annot_majorclass_heatmap_niche_kmean10_clean.pdf"), width=5, height=3)
print(p)
dev.off()
...
pdf(paste0(output_PATH, target_tissue, "_all_annot_majorclass_heatmap_niche_kmean12_clean.pdf"), width=5, height=3)
print(p)
dev.off()
