...
###p=fviz_nbclust(x_comb, kmeans, method = "wss", k.max = 16, nstart = 25)

####pdf(paste0(output_PATH, target_tissue, "coembed.combined_inte_harmony_p6_harmony_anno_elbow_niches",ni,"_clean_subclass.pdf"))
####p + ggtitle("Elbow method for K-means")
####dev.off()

# Silhouette
p=fviz_nbclust(x_comb, kmeans, method = "silhouette", k.max = 16, nstart = 25)


pdf(paste0(output_PATH, target_tissue, "coembed.combined_inte_harmony_w1_harmony_anno_silhouette_niches",ni,"_clean_subclass1.pdf"))
...
pdf(paste0(output_PATH, target_tissue, "coembed.combined_inte_harmony_w1_harmony_anno_gap_stat_niches",ni,"_clean_subclass1.pdf"))
