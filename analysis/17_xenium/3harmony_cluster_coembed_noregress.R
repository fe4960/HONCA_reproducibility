...
merged_obj <- Seurat::ScaleData(merged_obj)
...
pdf(paste0(output_PATH, target_tissue, "coembed.combined_harmony_umap_noregress", ".pdf"), width = 12, height = 5)
...
saveRDS(merged_obj, paste0(output_PATH, target_tissue, "coembed.combined_inte_harmony_noregress", ".rds"))
