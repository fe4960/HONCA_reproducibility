...
merged_obj=merged_obj[features,]
...
pdf(paste0(output_PATH, target_tissue, "coembed.combined_harmony_umap", "_fea.pdf"), width = 12, height = 5)
...
saveRDS(merged_obj, paste0(output_PATH, target_tissue, "coembed.combined_inte_harmony", "_fea.rds"))

merged_obj=readRDS(paste0(output_PATH, target_tissue, "coembed.combined_inte_harmony", "_fea.rds"))

pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_fea.pdf"), width = 5, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_sampleid_fea.pdf"), width = 5, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_slide_fea.pdf"), width = 15, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_heatmap_fea.pdf"), width = 7, height = 7)
heatmap(tb)
dev.off()
...
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_slide_ct_fea.pdf"), width = 15, height = 5)
...
saveRDS(merged_obj, paste0(output_PATH, target_tissue, "coembed.combined_inte_harmony_fea", ".rds"))
