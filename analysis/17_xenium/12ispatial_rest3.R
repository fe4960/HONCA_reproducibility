...
saveRDS(integrated_merFISH, paste0(outdir, "/", slide_name, "_integrated_merFISH_metaxy.rds"))
...
p <- ggplot(data.frame(x = cor_list), aes(cor_list)) +
  ...
  theme_classic()
pdf(paste0(outdir, "/", slide_name, "_pcc_distribution_metaxy.pdf"), width = 4, height = 3)
