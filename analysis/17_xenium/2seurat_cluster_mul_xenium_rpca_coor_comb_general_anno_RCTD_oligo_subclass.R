...
RCTD=readRDS(paste0(output_PATH, "/spacexr/",label,"_", slide_id, "_subclass1_RCTD_results_nonneuron.rds"))
...
#pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_subclass1_",slide_id,"_cutoff",cut,"_fc_",fc,"_rctd1_only_heatmap.pdf"), width = 7, height = 7)
#heatmap(tb)
#dev.off()
...
#pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_subclass1_",slide_id,"_cutoff",cut,"_fc_",fc,"_",clu,"_only.pdf"), width = 50, height = 35)
...
#pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_subclass1_",slide_id,"_cutoff",cut,"_fc_",fc,"_rctd1_only_majority_vote_anno.pdf"), width = 50, height = 35)
...
pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_subclass1_",slide_id,"_cutoff",cut,"_fc_",fc,"_rctd1_only_subclass1_singlet.pdf"), width = 50, height = 35)
...
#pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_subclass1_",slide_id,"_cutoff",cut,"_fc_",fc,"_rctd1_only_majority_vote_anno_singlet.pdf"), width = 50, height = 35)
#p=ImageDimPlot(object = xenium_obj, group.by = "rctd_anno", border.size = 1,  axes=TRUE, dark.background=TRUE,  border.color=NA) # , cols = "polychrome")
#print(p)
#dev.off()


#pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_subclass1_",slide_id,"_cutoff",cut,"_fc_",fc,"_harmony_anno_only.pdf"), width = 50, height = 35)
####pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_subclass1_",slide_id,"_cutoff",cut,"_fc_",fc,"_harmony_anno_only_harmony_clu_15.pdf"), width = 50, height = 35)
...
fn=paste0(output_PATH, target_tissue, "_",label,"_annot_subclass1_",slide_id,"_cutoff",cut,"_fc_",fc,"_rctd1_only_subclass1_y_coor_bin.pdf")
