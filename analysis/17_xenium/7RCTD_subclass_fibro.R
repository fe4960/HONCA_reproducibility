...
xenium_data_list=readRDS(paste0(output_PATH1, target_tissue,"_6_xenium_data_list_comb_cutoff20.rds"))
label=args[2]
...
#  RCTD <- create.RCTD(query, reference, max_cores = 28, UMI_min = 0, gene_cutoff = 0.000125, fc_cutoff = 1, gene_cutoff_reg = 0.0002, fc_cutoff_reg = 1) #nonneuron1
#  RCTD <- create.RCTD(query, reference, max_cores = 28, UMI_min = 0) #nonneuron
  ...
  RCTD <- create.RCTD(query, reference, max_cores = 1, UMI_min = 0, gene_cutoff = 0.0001, fc_cutoff = 0.15, gene_cutoff_reg = 0.0002, fc_cutoff_reg = 0.3) #nonneuron1
...
#  saveRDS(RCTD, paste0(output_PATH, label,"_", t, "_", clu, "_", label1, "_RCTD_results_nonneuron.rds"))
#  saveRDS(RCTD, paste0(output_PATH, label,"_", t, "_", clu, "_", label1, "_RCTD_results_nonneuron025.rds"))
  saveRDS(RCTD, paste0(output_PATH, label,"_", t, "_", clu, "_", label1, "_6_RCTD_results_nonneuron015.rds"))
...
#   saveRDS(RCTD, paste0(output_PATH, label,"_", t, "_",clu,"_RCTD_results_nonneuron1.rds"))
