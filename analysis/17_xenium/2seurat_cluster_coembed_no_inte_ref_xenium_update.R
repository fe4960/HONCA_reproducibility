...
xenium.combined=readRDS("/dfs3b/ruic20_lab/junw42/HCA_ON/data/8_spatial/Xenium/20250620_PP_comb/ONONH_comb/ONONH_comb_6_xenium.combined_cutoff20.rds")
#xenium_data_list=readRDS(paste0(output_PATH, target_tissue, "_xenium_data_list_cutoff20.rds"))
xenium_data_list=readRDS("/dfs3b/ruic20_lab/junw42/HCA_ON/data/8_spatial/Xenium/20250620_PP_comb/ONONH_comb/ONONH_comb_6_xenium_data_list_comb_cutoff20.rds")
...
saveRDS(coembed.combined, paste0(output_PATH, target_tissue, "_6_coembed.combined_cutoff20_ref_xenium_no_inte_harmony.rds"))
#coembed.combined@meta.data$stat=Idents(coembed.combined)

pdf(paste0(output_PATH, target_tissue, "_6_xenium_umap_cutoff20_ref_xenium_no_inte.pdf"), width = 6, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_6_xenium_umap_p5_cutoff20_facet_ref_xenium_no_inte.pdf"), width = 12, height = 5)
