...
#xenium.combined=readRDS("/dfs3b/ruic20_lab/junw42/HCA_ON/data/8_spatial/Xenium/20250620_PP_comb/ONONH_comb/ONONH_comb_xenium.combined_cutoff20.rds")
...
#xenium_data_list=readRDS("/dfs3b/ruic20_lab/junw42/HCA_ON/data/8_spatial/Xenium/20250620_PP_comb/ONONH_comb/ONONH_comb_xenium_data_list_comb_cutoff20.rds")
...
#ONONH_comb_fibro_xenium.combined_cutoff20_fc_5
#######saveRDS(coembed.combined, paste0(output_PATH, target_tissue, "_fibro_ref_xenium_no_inte_cutoff20_fc_5_harmony.rds"))
...
#####pdf(paste0(output_PATH, target_tissue, "_fibro_ref_xenium_no_inte_cutoff20_fc_5_harmony_cluster.pdf"), width = 6, height = 5)
...
######pdf(paste0(output_PATH, target_tissue, "_fibro_ref_xenium_no_inte_cutoff20_fc_5_harmony_cluster_facet.pdf"), width = 12, height = 5)
