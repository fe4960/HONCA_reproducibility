...
adata.obs["leiden"]=adata1.obs.loc[idx,"leiden"].astype(str)
...
#dt={"0": f"{celltype}_PPS_1", "1": f"{celltype}_LC?", "2": f"{celltype}_sclera", "3": f"{celltype}_PPS_sclera", "4": f"{celltype}_RPEchoroid", "5" : f"{celltype}_Fibro_x"}
