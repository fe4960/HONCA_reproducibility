...
on_oligo=sc.read("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Oligodendrocyte/clean/Oligodendrocyte_subclass_seurat.h5ad")
on_oligo.X=on_oligo.layers["counts"]

on_opc=sc.read("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Oligodendrocyte_precursor_cell/clean/Oligodendrocyte_precursor_cell_subclass_seurat.h5ad")
on_opc.X=on_opc.layers["counts"]
...
astro=ad.concat([on_astro, ret_astro, mg, ret_mg, on_oligo, on_opc])

#astro.write("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Astrocyte/clean/Astro_ret_ONONH.h5ad")

astro.write("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Astrocyte/clean/Astro_ret_ONONH_mg_oligo_opc_update.h5ad")
