...
adata.obs["subclass"]="NKT_cell"
sc.settings.figdir = f"{outdir}/figures"
obs=pd.read_csv(f"{outdir}/{celltype}_res_0.6_clean_rm_res_0.6.obs.gz",header=0, index_col=0)
adata.obs.loc[obs.index,"leiden1"]=obs["leiden"].astype("str")
...
#celltype1="OPC"
adata=adata[adata.obs["leiden1"]!="7"]
dt={"0": "T_cell", "1": "T_cell", "2": "T_cell", "3": "NK_cell", "4": "B_cell", "5": "Mast_cell", "6": "B_cell_activated", "8": "Dendritic_cell"}
