...
bname=f"{celltype}_subclass_LC_other1"

#bname=f"{celltype}_subclass"
adata.obs["subclass"]="Fibroblast"
sc.settings.figdir = f"{outdir}/figures"

adata1=sc.read_h5ad(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_v3_rs_0.4_clean_rm4_sb_scvi_trg.h5ad")

#adata1=sc.read_h5ad(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_v3_rs_0.4_clean_rm4_6_13_sb_scvi_trg.h5ad")
...
#adata.obs["leiden"]=adata1.obs["leiden"].astype("str")

obs=pd.read_csv("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Fibroblast/clean/Fibroblast_hvg10000_epochnone_seurat_v3_res_0.6_clean_rm4_sb_res_0.6.obs.gz",header=0,index_col=0)

##obs=pd.read_csv("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Fibroblast/clean/Fibroblast_hvg10000_epochnone_seurat_v3_rs_0.6_clean_rm4_6_13_sb_res_0.3.obs.gz",header=0,index_col=0)

#lc=adata1[adata1.obs["leiden"]=="5"].obs.index

#obs=pd.read_csv("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Fibroblast/clean/Fibroblast_hvg10000_epochnone_seurat_v3_rs_0.3_clean_rm4_6_13_sb_res_0.3.obs.gz",header=0,index_col=0)

adata.obs["leiden"]=obs.loc[adata.obs.index,"leiden"].astype("str")

#obs=pd.read_csv("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Fibroblast/clean/Fibroblast_hvg10000_epochnone_seurat_v3_rs_0.3_clean_rm4_6_13_sb_kp_cl_16_res_0.3.obs.gz",header=0,index_col=0)
#ara_1=obs.loc[obs["leiden"]==0].index
#ara_2=obs.loc[obs["leiden"]==1].index

#tmp_adata=sc.read("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Fibroblast/clean/Fibroblast_hvg10000_epochnone_seurat_v3_rs_0.4_clean_rm4_6_13_sb_kp_cl_0_scvi_trg.h5ad")

#pia_2=tmp_adata[tmp_adata.obs["leiden"].isin(["1"])].obs.index

#pia_1=tmp_adata[tmp_adata.obs["leiden"].isin(["0","2"])].obs.index

#obs=pd.read_csv("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Fibroblast/clean/Fibroblast_hvg10000_epochnone_seurat_v3_rs_0.4_clean_rm4_6_13_sb_kp_cl_2_res_0.4.obs.gz",header=0,index_col=0)


#tmp_adata=sc.read("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Fibroblast/clean/Fibroblast_hvg10000_epochnone_seurat_v3_rs_0.4_clean_rm4_6_13_sb_kp_cl_2_scvi_trg.h5ad")

#dura_1=tmp_adata[tmp_adata.obs["leiden"].isin(["1","2"])].obs.index

#dura_2=tmp_adata[-tmp_adata.obs["leiden"].isin(["1","2"])].obs.index

#obs=pd.read_csv(f"{outdir}/{celltype}_res_0.2_clean_res_0.2.obs.gz",header=0, index_col=0)
#adata.obs.loc[obs.index,"subclass"]=obs["leiden"]
...
dt={"1": f"{celltype1}_pia", "6": f"{celltype1}_perivascular",   "0": f"{celltype1}_arachnoid", "7": f"{celltype1}_arachnoid", "3": f"{celltype1}_sclera", "2": f"{celltype1}_dura", "9": f"{celltype1}_dura", "10": f"{celltype1}_dura",  "4": f"{celltype1}_RPEchoroid", "8" : f"{celltype1}_x", "5" : f"{celltype1}_lamina_cribrosa"}
