...
#adata=sc.read_h5ad(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_v3_rs_0.4_clean_rm_rm_scvi_trg.h5ad")
adata=sc.read_h5ad(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_v3_rs_0.4_clean_rm_rm_scvi_trg.h5ad")
...
#adata.layers["counts"]=adata1.layers["counts"]
...
idx1=adata1.obs.loc[adata1.obs["leiden"]=="4"].index
#idx2=adata1.obs.loc[adata1.obs["leiden"]=="9"].index

sc.settings.figdir = f"{outdir}/figures"
obs=pd.read_csv(f"{outdir}/{celltype}_res_0.6_clean_sb_res_0.6.obs.gz",header=0, index_col=0)
...
celltype1="Endo"
dt={"0": "Capillary", "1": "Vein/Venule", "2": "Artery/Arteriole","3": "Venule_postcapillary", "4": "Capillary_fenestrated", "5": "Venule_dysfunction"}
