...
adata.obs["subclass"]="Schwann_cell"
...
obs=pd.read_csv(f"{outdir}/{celltype}_res_0.4_clean_sb_res_0.4.obs.gz",header=0, index_col=0)
...
dt={"0": f"{celltype}_nonmyelinating", "1": f"{celltype}_nonmyelinating", "2": f"{celltype}_myelinating"}
