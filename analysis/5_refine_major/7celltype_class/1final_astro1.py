...
bname=f"{celltype}_subclass_new2"
...
dt={"0": "Astro_ON", "2": "Astro_ON", "3": "Astro_ONONH",  "4": "Astro_ONONH", "5": "Astro_ON_AFF3+", "1": "Astro_ONH"}
...
adata.obs["subclass"]=adata.obs["subclass"].cat.add_categories(["Astro_retina","Astro_retina_NLGN1+"])
