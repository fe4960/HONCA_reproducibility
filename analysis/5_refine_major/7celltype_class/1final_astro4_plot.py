...
sc.pl.dotplot(adata,["PIEZO2","PIEZO1","TRPV4","GJA1","RAPGEF3","KCNK2", "KCNK15", "KCNK4", "KCNK3","KCNK5","KCNK9","KCNK13","KCNK12","KCNK2","KCNK10","KCNK18","KCNK1","KCNK6", "TRPV1", "TRPV2", "TRPV4", "TRPC1", "TRPC3", "TRPC5", "TRPC6", "TRPA1", "PKD2", "TRPM3", "TRPM4", "TRPM7"], groupby="subclass", save= "Astrocyte_subclass_new5_clean_mechanochannel.png" )
...
#group1 = adata[adata.obs["age_range"] == "<31"].to_df()["PIEZO2"]
#group2 = adata[adata.obs["age_range"] == ">70"].to_df()["PIEZO2"]

#stats.mannwhitneyu(group1, group2, alternative="greater")

outdir="/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Astrocyte/clean/"

for ct in adata.obs["subclass"].unique():

    bname=f"Astrocyte_subclass_new5_clean_{ct}_70_30"
