...
#adata=sc.read_h5ad("HCA_ON/data/5_refine_major/scvi/Endothelial_cell/clean/Endothelial_cell_hvg10000_epochnone_seurat_v3_rs_1_subclass_sb_seurat_rmRPE_scvi_trg.h5ad")

adata=adata[(adata.obs["sampleid"]!="MMD_23_17976_ONH_RNA")&(adata.obs["sampleid"]!="MMD_23_20181_ONH_RNA")]

bname=f"{celltype}_subclass_rmRPE"
...
obs=pd.read_csv(f"{outdir}/{celltype}_res_0.7_clean_rm_rm_res_0.7.obs.gz",header=0, index_col=0)
...
celltype1="Endo"
dt={"0": "Capillary_continuous", "1": "Venule", "2": "Arteriole","3": "Venule_postcapillary", "4": "Capillary_fenestrated", "5": "Venule_dysfunction"}
