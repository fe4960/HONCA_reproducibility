...
bname=f"{celltype}_subclass_clean_new_rename_rmRPE_seurat_v3_1"
...
obs=pd.read_csv(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_v3_rs_0.4_clean_sb_none_seed_7_rmRPE.obs.gz",header=0,index_col=0)
...
obs1=pd.read_csv(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_v3_rs_0.9_clean_sb_none_seed_7_rmRPE.obs.gz",header=0,index_col=0)
idx1=obs1.loc[obs1["leiden"]==8].index
...
dt={"0": "Fibro_arachnoid", "1": "Fibro_pia", "4": "Fibro_RPEchoroid", "3": "Fibro_sclera", "2": "Fibro_dura", "6": "Fibro_dura", "5": "Fibro_x"}
...
adata.obs.loc[idx1,"subclass"]="Fibro_perivascular"
