...
bname="${celltype}_hvg${hvg}_epoch${max_epoch}_${fl}_rs_${res}_clean_sb_${kp}_rm1_11_16_seed_${seed}"
...
obs_kp="none"
obs_rm="${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_hvg10000_epochnone_seurat_rs_1_clean_sb_none_seed_7.obs.gz"
item="leiden" #"none"
ntrg=10
mk="sanes_mk"
detail="t"
