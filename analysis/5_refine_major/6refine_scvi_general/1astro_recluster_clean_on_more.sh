...
#seed=12345
res=0.3
rmlist="none" #rm_cluster_rs1.2_4_9
fl="seurat"
hvg=10000
max_epoch="none"
gl="zinb"
...
#bname=${celltype}_hvg${hvg}_epoch${max_epoch}_seurat_rs_${res}_clean_sb_rm0_12_15_16_${kp}_rm4_9_seed_${seed}
bname=${celltype}_hvg${hvg}_epoch${max_epoch}_seurat_rs_0.2_clean_sb_rm0_12_15_16_merge_seed_${seed}_kp_0_res_${res}
label_key="none"
...
#obs="none"
obs_rm="none"
#obs_rm=${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_hvg10000_epochnone_seurat_rs_1.2_clean_sb_rm0_12_15_16_kp_cluster_0_1_3_4_seed_7.obs.gz
#obs_kp=${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_subclass_new2_rm_clu1_8_hvg10000_epochnone_seurat_rs_0.3_seed_7_clean_sb.obs.gz
#obs_kp="none"
obs_kp="${main}/HCA_ON/data/5_refine_major/scvi/Astrocyte/clean/Astrocyte_hvg10000_epochnone_seurat_rs_0.2_clean_sb_rm0_12_15_16_merge_seed_7.obs.gz"
...
python /dfs3b/ruic20_lab/junw42/HCA_ON/scripts/4_integrateRNA/4scVI_cluster_raw.py $query $celltype ${batch_key} $bname ${label_key} $outdir $label $hvg $sb $nlat $norm $obs_rm $item $max_epoch $rmlist $seed $ntrg $mk $indir $res $detail $fl $gl $span $dirrm $rank $kp $obs_kp
