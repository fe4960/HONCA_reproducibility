...
#seed=12345
res=0.3
rmlist=rm_cluster_rs0.3_2
fl="seurat"
hvg=10000
max_epoch="none"
gl="zinb"
span=1
kp="none" #kp_cluster_2
batch_key="sampleid"
...
bname=${celltype}_hvg${hvg}_epoch${max_epoch}_seurat_rs_${res}_clean_sb_rm0_12_15_16_${kp}_rm2_seed_${seed}
...
#obs="none"
obs_rm=${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_hvg10000_epochnone_seurat_rs_0.3_clean_sb_rm0_12_15_16_kp_cluster_2_seed_7.obs.gz
