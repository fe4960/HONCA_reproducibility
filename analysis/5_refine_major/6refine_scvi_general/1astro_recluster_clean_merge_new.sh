...
#query=${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_hvg10000_epochnone_seurat_rs_0.6_clean_sb_rm0_12_15_16_merge_seed_7_scvi_trg.h5ad
...
bname=${celltype}_hvg${hvg}_epoch${max_epoch}_seurat_rs_${res}_clean_sb_rm0_12_15_16_merge_seed_${seed}_rm9_10
...
#obs=${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_hvg10000_epochnone_seurat_rs_0.3_clean_sb_rm0_12_15_16_none_rm4_9_rm2_seed_7.obs.gz
#obs=/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Astrocyte/clean/Astrocyte_hvg10000_epochnone_seurat_rs_0.6_clean_sb_rm0_15_16_seed12345_rs0.8_rm5_9_seed_7_rm_retonh_clu2_clu4.obs.gz
obs=${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_hvg10000_epochnone_seurat_rs_0.6_clean_sb_rm0_12_15_16_merge_seed_7.obs.gz
obs_kp="none"
