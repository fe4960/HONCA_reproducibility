...
query=/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Astrocyte/clean/Astro_ret_ONONH_update.h5ad
batch_key="sampleid"
...
bname="Astro_ret_ONONH_hvg${hvg}_epoch${max_epoch}_${fl}_rs_${res}_rm${rmlist}_sb"
