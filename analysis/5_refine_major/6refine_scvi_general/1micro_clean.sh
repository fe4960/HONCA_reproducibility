...
norm="n"
obs="${main}/HCA_ON/data/5_refine_major/scvi/Microglia/clean/Microglia_hvg10000_epochnone_seurat_rs_0.7_rmnone_sb.obs.gz" #"${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_hvg10000_epochnone_seurat_rs_1.2_clean_rm4_15_sb_none.obs.gz"

#obs="${main}/HCA_ON/data/5_refine_major/scvi/Microglia/clean/Microglia_hvg10000_epochnone_seurat_rs_1_rmnone_sb.obs.gz" #"${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_hvg10000_epochnone_seurat_rs_1.2_clean_rm4_15_sb_none.obs.gz"
obs_kp="none"
item="leiden" #"none"
ntrg=10
mk="sanes_mk"
