...
#bname="${celltype}_hvg${hvg}_epoch${max_epoch}_${fl}_rs_${res}_clean_rm4_15_sb_${kp}_rm1.2_6"
...
obs="${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_hvg10000_epochnone_seurat_rs_1.2_clean_rm4_15_sb_none.obs.gz"
obs_kp="none"
item="leiden" #"none"
ntrg=10
mk="sanes_mk"
...
bname="${celltype}_hvg${hvg}_epoch${max_epoch}_${fl}_rs_${res}_clean_res0.3rm1_sb_${kp}_flt_${flt}"
