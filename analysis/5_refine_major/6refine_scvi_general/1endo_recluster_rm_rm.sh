...
query=${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_hvg2000_epochnone_seurat_rs_0.4_clean_rm_scvi_trg.h5ad
batch_key="sampleid"
...
bname="${celltype}_hvg${hvg}_epoch${max_epoch}_${fl}_rs_${res}_clean_rm_sb_rm_4_6_${kp}"
...
obs="/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Endothelial_cell/clean/Endothelial_cell_hvg10000_epochnone_seurat_rs_0.6_clean_rm_sb_none.obs.gz"
obs_kp="none"
item="leiden" #"none"
ntrg=10
mk="sanes_mk"
