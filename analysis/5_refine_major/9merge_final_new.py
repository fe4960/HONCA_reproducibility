...
ct=["BC","Oligodendrocyte_precursor_cell","Mural_cell", "AC","RPE", "HC","Cone","NK_T_cell"]
...
adata=sc.read(f'/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Astrocyte/clean/Astrocyte_subclass_new2.h5ad')
ad_list.append(adata)


adata=sc.read(f'/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Fibroblast/clean/Fibroblast_subclass_LC_other1.h5ad')
ad_list.append(adata)
...
adata_full.write("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/ON_ONH_clean_new.h5ad")
adata_full.obs.to_csv("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/ON_ONH_clean_new.obs.gz")
adata_full.var.to_csv("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/ON_ONH_clean_new.var.gz")
