...
for res in 0.1 0.2 0.3 #1.1 1.2 1.5 2 #0.5 0.6 0.7 0.8 1
do
...
h5ad=${outdir}/${cell}_hvg10000_epochnone_seurat_rs_0.4_clean_rm4_15_sb_none_scvi_trg.h5ad

bname=${cell}_hvg10000_epochnone_seurat_rs_${res}_clean_rm4_15_sb_none
