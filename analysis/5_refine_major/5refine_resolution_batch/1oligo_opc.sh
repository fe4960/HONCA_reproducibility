...
h5ad=${outdir}/${cell1}_hvg10000_epochnone_seurat_rs_0.4_clean_sb_none_scvi_trg.h5ad

bname=${cell1}_hvg10000_epochnone_seurat_rs_${res}_clean_sb_none
