...
mk=["AQP4", "APOE", "SOX9", "GFAP", "SOX2", "VIM", "GJA1",  "ID1", "SOX11", "HES6", "NES", "TUBB", "CSPG4", "PTPRZ1", "SOX6", "DCC", "PDGFRA", "OLIG1", "OLIG2", "SOX10", "MBP", "MOG", "CA10", "SOX1", "GLI1", "MSI1"]
sc.pl.dotplot(adata, mk, groupby="subclass", save="_Astrocyte_subclass_new5_clean_stemness_important_oligo.pdf", categories_order=level)
...
sc.pl.dotplot(adata, mk, groupby="subclass", save="_oligo_opc_seurat_new_scvi_cycling_stem.pdf")
