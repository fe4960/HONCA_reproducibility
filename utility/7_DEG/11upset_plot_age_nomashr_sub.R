...
#cells=c("Oligodendrocyte")
#cells=c("Astrocyte")
cells=c("Fibroblast")
for(cell in cells){
#file=paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/",cell,"_majorclass_DEG/",cell,"_upset_list_age_cpm1_all_ct_nomashr_tab")
file=paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/genexp_donor_subclass_final_new/", cell, "_subclass_DEG/", cell,"_upset_list_age_cpm1_all_ct_nomashr_tab")
...
pdf(paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/genexp_donor_subclass_final_new/", cell, "_subclass_DEG/", cell,"_upset_list_age_cpm1_all_ct_nomashr.pdf"),width=10)
