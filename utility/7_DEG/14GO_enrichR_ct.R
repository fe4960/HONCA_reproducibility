...
dirIn=paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/",od,"/",ct,"_subclass_DEG/",ct,"/",cell,"_DEG_GO_",dem,"_up")
...
dirIn=paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/7_DEG/",od,"/",ct,"_subclass_DEG/",ct,"/",cell,"_DEG_GO_",dem,"_down")
dir.create(dirIn,recursive = TRUE)
setwd(dirIn)
