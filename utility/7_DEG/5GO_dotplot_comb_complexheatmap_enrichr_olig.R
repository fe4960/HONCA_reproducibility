...
rm_up=read.table("HCA_ON/scripts/7_DEG/5GO_dotplot_comb_complexheatmap_enrichr_oligo_rm_up", header=F, sep="\t")
rm_down=read.table("HCA_ON/scripts/7_DEG/5GO_dotplot_comb_complexheatmap_enrichr_oligo_rm_down", header=F, sep="\t")
...
write.table(df_up_all, file=paste0(dir1,"oligo_all_enrichr_MSigDB_up_heatmap_top10_",sam, "_top_5"), sep="\t", quote=F)
write.table(df_down_all, file=paste0(dir1,"oligo_all_enrichr_MSigDB_down_heatmap_top10_",sam, "_top_5"), sep="\t", quote=F)
...
# Apply the function
short_names <- shorten_names(gsub("\\."," ", colnames(mat_scaled)), width = 25)
out=paste0(dir1,"oligo_all_enrichr_MSigDB_up_heatmap_top10_", sam, "_top_5.pdf")
...
# Apply the function
short_names <- shorten_names(gsub("\\."," ", colnames(mat_scaled)), width =25)
out=paste0(dir1,"oligo_all_enrichr_MSigDB_down_heatmap_top10_", sam,"_top_5.pdf")
