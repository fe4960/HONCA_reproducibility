...
pdf("major_cellcell_interaction_dominate_sender_receiver_scatter.pdf")
gg1
dev.off()
...
pdf("major_cellcell_interaction_dominate_sender_receiver_heatmap.pdf",width=12,height=15)
ht1 + ht2
dev.off()
...
pdf("major_cellcell_interaction_Astrocyte_5target.pdf",height=15)
netVisual_bubble(cellchat, sources.use = "Astrocyte",targets.use = c("Astrocyte","Oligodendrocyte","Oligodendrocyte_precursor_cell","Endothelial_cell","Mural_cell"), remove.isolate = FALSE)
dev.off()

pdf("major_cellcell_interaction_Astrocyte_5to5.pdf",height=15)
netVisual_bubble(cellchat, sources.use = c("Astrocyte","Oligodendrocyte","Oligodendrocyte_precursor_cell","Endothelial_cell","Mural_cell"),targets.use = c("Astrocyte","Oligodendrocyte","Oligodendrocyte_precursor_cell","Endothelial_cell","Mural_cell"), remove.isolate = FALSE)
dev.off()
