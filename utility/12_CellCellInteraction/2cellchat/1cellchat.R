...
pdf("major_cellcell_interaction.pdf",width=15)
...
pdf("major_cellcell_interaction_sign_pair_bubble.pdf",width=12,height=15)
...
nPatterns = 6
pdf("major_cellcell_interaction_MCP_out_heatmap.pdf",width=15)
...
pdf("major_cellcell_interaction_MCP_in_heatmap.pdf",width=15)
