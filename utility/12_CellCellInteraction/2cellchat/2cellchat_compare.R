...
pdf(paste0(wd2,"g_", g, "_compareInt_signalChanges_scatter_Oligo.pdf"),width=25,height=10)
...
gg4 <- netAnalysis_signalingChanges_scatter(cellchat, idents.use = "Astro_ONHON1_SLC4A11+MARCH1+")
...
gg6 <- netAnalysis_signalingChanges_scatter(cellchat, idents.use = "Astro_ONH")
...
patchwork::wrap_plots(plots = list(gg1, gg4, gg5, gg6,  gg8))
