...
param<-DLG.get.param(k = 2, seed1 = 7, results.dir = "/dfs3b/ruic20_lab/junw42/HCA_ON/data/10_DIALOGUE/DIALOGUE/glia_only_on_noPlot_2k_noAge/",covar=c("cellQ"), frm= "y ~ (1|donor) + x + cellQ",  n.genes = 100, conf = "cellQ", spatial.flag = F,plot.flag = F) # ,pheno = "agerange")

R <- DIALOGUE.run(rA = rA, # list of cell.type objects
                    main = "ONONH_glia_only",
                    param = param)
saveRDS(R,file="/dfs3b/ruic20_lab/junw42/HCA_ON/data/10_DIALOGUE/DIALOGUE/glia_only_on_noPlot_2k_noAge/glia_only_on_noPlot.rds")
