...
param<-DLG.get.param(k = 6,results.dir = "/dfs3b/ruic20_lab/junw42/HCA_ON/data/10_DIALOGUE/DIALOGUE/glia_only_noPlot/",covar=c("cellQ"), frm= "y ~ (1|donor) + x + cellQ",  n.genes = 200, conf = "cellQ", spatial.flag = F,plot.flag = F ,pheno = "agerange")

R <- DIALOGUE.run(rA = rA, # list of cell.type objects
                    main = "ONONH_glia_only",
                    param = param)
saveRDS(R,file="/dfs3b/ruic20_lab/junw42/HCA_ON/data/10_DIALOGUE/DIALOGUE/glia_only_noPlot/glia_only_noPlot.rds")
