...
#mk=["SOX8", "SOX9", "SOX10", "SOX18", "SOX14", "SOX1", "SRY", "EP300", "PAX5"]
#mk=["SOX9"]
mk1="LAMA"
#mk=[mk1]
mk=["LAMA1", "LAMA2", "LAMA3", "LAMA4", "LAMA5", "LAMB1", "LAMB2", "LAMB3", "LAMC1", "LAMC2", "LAMC3"]
#sc.pl.violin(adata,mk, groupby="majorclass", save=f"_TF_majorclass_nodot.pdf", jitter=False, rotation=90)
#sc.pl.dotplot(adata, mk, groupby="majorclass", save=f"_TF_majorclass.pdf", swap_axes=True)
sc.pl.violin(adata,mk, groupby="majorclass", save=f"_majorclass_nodot_{mk1}.pdf", jitter=False, rotation=90)
sc.pl.dotplot(adata, mk, groupby="majorclass", save=f"_majorclass_{mk1}.pdf", swap_axes=True)
...
mk=["ITGA1", "ITGA2", "ITGA3", "ITGA6", "ITGB1", "ITGA7",  "ITGA9",  "ITGAV", "ITGB8",  "ITGB4", "CD44", "SV2A", "SV2B", "SV2C", "DAG1"]
adata.obs["subclass"] = (
    adata.obs["subclass"]
    .astype("category")
...
#sc.pl.dotplot(adata, mk, groupby="subclass", save=f"_TF_astro_sub_class.pdf", swap_axes=True)
#sc.pl.violin(adata,mk, groupby="subclass", save=f"_TF_astro_sub_class_nodot.pdf", jitter=False, rotation=90)

sc.pl.dotplot(adata, mk, groupby="subclass", save=f"_astro_sub_class_{mk1}.pdf", swap_axes=True)
sc.pl.violin(adata,mk, groupby="subclass", save=f"_astro_sub_class_nodot_{mk1}.pdf", jitter=False, rotation=90)
