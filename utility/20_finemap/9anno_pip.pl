...
my $eQTL_file = "/dfs3b/ruic20_lab/junw42/reference/eQTL/retina/all_TRUE_hg19_retina_gencodeHg19";
my %eQTL=();
...
my @cell = ("Astrocyte", "Endothelial", "Fibroblast", "Immune", "Macrophage", "Melanocyte", "MG", "Microglia", "Mural", "Oligodendrocyte", "OPC");
my %peak_all=();
my %peak_var=();
...
#my $file="/storage/chenlab/Users/junwang/human_ret_anc/data/proj1_clean_remap_HRCA_rmMulti_clean_final/$cell"."_DAR_peak_FDR005_hg38_hg19";
my $file = "/dfs3b/ruic20_lab/junw42/HCA_ON/data/12_snATAC/majorclass/DAR/$cell"."_DAR_peak_FDR005_hg38_hg19";
open(INPUT,$file);
<INPUT>;
while(my $line = <INPUT>){
chomp $line;
...
#my $CRE_list = "/storage/chenlab/Users/junwang/human_ret_anc/data/proj1_clean_remap_HRCA_rmMulti_clean_final/g2p_cA_final_major_full_max_LCRE_uniq_clean_hg38_hg19_out_CRE";
my $CRE_list = "HCA_ON/data/12_snATAC/majorclass/g2p_cA_final_major_full_max_LCRE_uniq_clean_hg38_hg19_out_CRE";
#hg38    hg19    gene
...
#my $file = "/dfs3b/ruic20_lab/jinjingj/human_atlas_atac/finemap/output/".$fn."_pip_var_all_merged";
my $file = "/dfs3b/ruic20_lab/junw42/reference/GWAS/finemap_sumstat/suise/".$fn."_pip_var_all_merged_uniform";
#my $file = "/storage/chenlab/Users/junwang/human_meta/data/finemap/".$fn."_pip_var_all_merged";
my $output1=$file."_anno_ON";
my $output2=$file."_finemap_gene_ON";
my %finemap_gene;
...
my $peak="NA";
if(exists $peak_var{$var_pos}){
$peak = $peak_var{$var_pos};
if(exists $DAR{$peak}){
#$cellline=join("|", %{$DAR{$peak}})
for my $key ( keys %{$DAR{$peak}}){
$gene .= "dar:$key|";
}
}
if(exists $CRE{$peak}){
...
#}
#}
print OUTPUT1 "$line\tanno;$cate\tgene;$gene\teQTL;$eQTLL\tpeak;$peak\n";
