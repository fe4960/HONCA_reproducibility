...
Early_progenitor = c("SOX2", "NES", "FABP7", "EGFR", "HES1", "HES5", "MCM2", "MCM6", "PCNA")

Fully_proliferative=c("MKI67", "TOP2A", "CDK1", "AURKB", "BIRC5", "UBE2C")

Reactive_astrocyte=c(	"GFAP", "CD44", "STAT3", "VIM", "SERPINA3", "C3")

Neurogenic_transition=c( "ASCL1", "DCX", "NEUROD1", "STMN2", "TUBB3"  )
...
GS_NSC <- list(
  ...
  Early_progenitor = Early_progenitor,
  Fully_proliferative = Fully_proliferative,
  Reactive_astrocyte = Reactive_astrocyte,
  Neurogenic_transition = Neurogenic_transition
)
