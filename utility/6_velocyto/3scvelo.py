...
dir1="/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Oligodendrocyte/clean/veloc"

#adata = sc.read("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Oligodendrocyte/clean/oligo_opc.h5ad")
#adata=sc.read("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/major/clean/major_seed_7_res_0.4_olig_opc_merge_new_scvi_trg.h5ad")
adata=sc.read("/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/major/clean/major_hvg_2000_res_0.4_fl_seurat_v3_olig_opc_merge_new_scvi_trg.h5ad")
...
hvg=int(2000)
#bname=f"oligo_opc_hvg_{hvg}_raw"
bname=f"oligo_opc_hvg_{hvg}_raw_new"
#bname=f"oligo_opc_hvg_{hvg}_raw_new_pca"
...
ldata = sc.read(f"/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Oligodendrocyte/clean/oligo_opc_sp_loom.h5ad")
...
scv.pl.velocity_embedding_stream(adata, color="subclass", basis='umap', save=f'{dir1}/{bname}_velocity.png')
