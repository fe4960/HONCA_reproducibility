...
#sbatch -p free-gpu --mem=250GB --time=2-20 --account=ruic20_lab --error=${err}/${h5ad}.err --output=${err}/${h5ad}.out $comd  $indir $h5ad ${h5ad}_hvg_${hvg}_raw  $hvg
#sbatch -p free-gpu --mem=250GB --time=2-20 --account=ruic20_lab --error=${err}/${h5ad}.err --output=${err}/${h5ad}.out $comd  $indir $h5ad ${h5ad}_cycling_hvg_${hvg}_raw  $hvg
...
err=/dfs3b/ruic20_lab/junw42/HCA_ON/scripts/6_velocyto/3scvelo_general_latent_velocity_batch
mkdir $err
comd=/dfs3b/ruic20_lab/junw42/HCA_ON/scripts/6_velocyto/3scvelo_general_latent_velocity.sh
