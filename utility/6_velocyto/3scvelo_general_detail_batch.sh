...
err=/dfs3b/ruic20_lab/junw42/HCA_ON/scripts/6_velocyto/3scvelo_general_detail_rename
mkdir $err
comd=/dfs3b/ruic20_lab/junw42/HCA_ON/scripts/6_velocyto/3scvelo_general_detail_rename.sh
...
#h5ad="oligo_opc_hvg_2000_raw_new"
h5ad="oligo_opc_seurat_new_scvi"
#sbatch -p free-gpu --mem=100GB --time=0-20 --account=ruic20_lab --error=${err}/${h5ad}.err --output=${err}/${h5ad}.out $comd  $indir $h5ad ${h5ad}_hvg_${hvg}_raw  $hvg

#sbatch -p standard --mem=100GB --time=0-20 --account=ruic20_lab --error=${err}/${h5ad}.err --output=${err}/${h5ad}.out $comd  $indir $h5ad ${h5ad}  $hvg
...
#sbatch -p free-gpu --mem=100GB --time=0-20 --account=ruic20_lab --error=${err}/${h5ad}.err --output=${err}/${h5ad}.out $comd  $indir $h5ad ${h5ad}_hvg_${hvg}_raw  $hvg
#sbatch -p free-gpu --mem=100GB --time=0-20 --account=ruic20_lab --error=${err}/${h5ad}.err --output=${err}/${h5ad}.out $comd  $indir $h5ad ${h5ad}_cycling_hvg_${hvg}_raw  $hvg

indir="/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Oligodendrocyte/clean/"
#h5ad="Oligodendrocyte_subclass_seurat"
h5ad="oligo_opc_seurat_new_scvi"
#h5ad="oligo_opc_seurat"

#sbatch -p free-gpu --mem=200GB --time=0-20 --account=ruic20_lab --error=${err}/${h5ad}.err --output=${err}/${h5ad}.out $comd  $indir $h5ad ${h5ad}_hvg_${hvg}_raw  $hvg
sbatch -p free-gpu --mem=150GB --time=0-10 --account=ruic20_lab --error=${err}/${h5ad}.err --output=${err}/${h5ad}.out $comd  $indir $h5ad ${h5ad}_cycling_hvg_${hvg}_raw  $hvg
