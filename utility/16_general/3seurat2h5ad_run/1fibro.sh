#!/bin/sh
comd="/dfs3b/ruic20_lab/junw42/HCA_ON/scripts/16_general/3seurat2h5ad"
mkdir $comd
...
for i in PP_2 #PP_1  PP_2  ONH_1  ONH_2 ONH_3  #{1..5}
do
#echo "oligo"
#s="ONONH_comb_xenium_merge_cutoff20_major_${i}"
s=ONONH_comb_fibro_xenium.combined_cutoff20_fc_5_${i}
sh sb.sh -c ${comd}.sh -m 70 -t 0-1 -p fg -e $comd -j $s -- $s $dir
done
