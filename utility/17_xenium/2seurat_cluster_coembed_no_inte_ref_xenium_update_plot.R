...
tb=table(merged_obj@meta.data[,c("w1_clusters","majorclass")])
pdf(paste0(output_PATH, target_tissue, "_6_xenium_umap_facet_ref_xenium_combined_inte_harmony_clu_1_2_ct_heatmap.pdf"), width = 7, height = 7)
heatmap(tb)
dev.off()
...
#table(merged_obj@meta.data[,c("majorclass","harmony_clusters_w1")])
#tb=table(merged_obj@meta.data[,c("harmony_clusters_w1","majorclass")])
#pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_clu_w1_ct_heatmap.pdf"), width = 7, height = 7)
#heatmap(tb)
#dev.off()
...
anno[anno$ct=="T_cell","ct"]="Immune_cell"
...
merged_obj@meta.data$harmony_anno[merged_obj@meta.data$w1_clusters==i]=anno[anno$p1_2_clu==i,]$ct
...
pdf(paste0(output_PATH, target_tissue, "_6_xenium_umap_facet_ref_xenium_combined_inte_harmony_slide_ct_anno_w1.pdf"), width = 20, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_6_xenium_umap_facet_ref_xenium_combined_inte_harmony_ident_ct_anno_w1.pdf"), width = 10, height = 5)
DimPlot(merged_obj, reduction = "umap", group.by="harmony_anno", split.by="ident", label =TRUE) + NoLegend()
dev.off()


#pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_clu_1_2_ct_anno_w1.pdf"), width = 10, height = 5)
#DimPlot(merged_obj, reduction = "umap", group.by="harmony_clusters_w1", split.by="ident", label =TRUE) + NoLegend()
...
pdf(paste0(output_PATH, target_tissue, "_6_xenium_umap_facet_ref_xenium_combined_inte_harmony_clu_1_2_ct_anno_nFea5_w1.pdf"), width = 10, height = 5)
#DimPlot(merged_obj1, reduction = "umap", group.by="harmony_clusters_w1", split.by="ident", label =TRUE) + NoLegend()

#DimPlot(merged_obj1, reduction = "umap", group.by="harmony_clusters_1_5", split.by="ident", label =TRUE) + NoLegend()

DimPlot(merged_obj1, reduction = "umap", group.by="harmony_anno", split.by="ident", label =TRUE) + NoLegend()
...
pdf(paste0(output_PATH, target_tissue, "_6_xenium_umap_facet_ref_xenium_combined_inte_harmony_majorclass_ct_anno_w1.pdf"), width = 10, height = 5)
DimPlot(merged_obj, reduction = "umap", group.by="majorclass", split.by="ident", label =TRUE) + NoLegend()
dev.off()



saveRDS(merged_obj, file=paste0(output_PATH, target_tissue, "_6_coembed.combined_inte_harmony_w1", ".rds"))
...
pdf(paste0(output_PATH, target_tissue, "_6_all_annot_majorclass_", slide_id, "_w1.pdf"), width = 50, height = 35)
