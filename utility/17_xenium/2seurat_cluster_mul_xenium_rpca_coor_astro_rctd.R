...
RCTD=readRDS(paste0(output_PATH, "/spacexr/",label,"_", id[i],"_",sc, "_RCTD_results_nonneuron.rds"))
...
fn=paste0(output_PATH, target_tissue,"_",label,"_cell_cluster_dist_x_",id[i],"_rctd1.pdf")
...
fn=paste0(output_PATH, target_tissue,"_",label,"_cell_cluster_dist_y_",id[i],"_rctd1.pdf")
...
############3xenium_obj=xenium_data_list[[i]]
