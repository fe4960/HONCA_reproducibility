...
#    cluster <- as.factor(tg.ref$subclass)
  ...
  RCTD <- create.RCTD(query, reference, max_cores = 28, UMI_min = 0, gene_cutoff = 0.0001, fc_cutoff = 0.05, gene_cutoff_reg = 0.0001, fc_cutoff_reg = 0.1)
  RCTD <- run.RCTD(RCTD, doublet_mode = "doublet")
  
#  saveRDS(RCTD, paste0(output_PATH, label,"_", t, "_RCTD_results_nonneuron.rds"))
   saveRDS(RCTD, paste0(output_PATH, label,"_", t, "_",clu,"_RCTD_results_nonneuron_01.rds"))
