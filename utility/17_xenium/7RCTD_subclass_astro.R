...
#    RCTD <- create.RCTD(query, reference, max_cores = 1, UMI_min = 0, gene_cutoff = 0.000125, fc_cutoff = 0.25, gene_cutoff_reg = 0.0002, fc_cutoff_reg = 0.5) #nonneuron025 1 core
...
# RCTD <- create.RCTD(query, reference, max_cores = 1, UMI_min = 0, gene_cutoff = 0.000125, fc_cutoff = 0.20, gene_cutoff_reg = 0.0002, fc_cutoff_reg = 0.3) ###nonneuron020
...
####   saveRDS(RCTD, paste0(output_PATH, label,"_", t, "_",clu,"_RCTD_results_nonneuron025_default.rds"))
