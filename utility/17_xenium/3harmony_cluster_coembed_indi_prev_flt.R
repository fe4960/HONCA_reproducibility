...
xenium_data_list <- lapply(X = xenium_data_list, FUN = function(x) {
  x <- NormalizeData(x)
  x <- ScaleData(x, features = features, verbose = FALSE, vars.to.regress = "nCount_Xenium")
...
pdf(paste0(output_PATH, target_tissue, "coembed.combined_harmony_umap_",label, "_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,".pdf"), width = 12, height = 5)
...
saveRDS(merged_obj, paste0(output_PATH, target_tissue, "coembed.combined_inte_harmony_",label, "_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,".rds"))

merged_obj=readRDS(paste0(output_PATH, target_tissue, "coembed.combined_inte_harmony_",label, "_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,".rds"))

pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_",label,"_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,".pdf"), width = 5, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_sampleid_",label,"_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,".pdf"), width = 5, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_slide_",label,"_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,".pdf"), width = 15, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_heatmap_",label,"_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,".pdf"), width = 7, height = 7)
heatmap(tb)
dev.off()
...
#####
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_",label,"_anno_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,".pdf"), width = 15, height = 5)
DimPlot(merged_obj, reduction = "umap", group.by="harmony_anno",label=F,split.by="slide") #+ NoLegend()
dev.off()

pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_",label,"_subclass_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,".pdf"), width = 15, height = 5)
DimPlot(merged_obj, reduction = "umap", group.by=sc,label=F,split.by="slide") #+ NoLegend()
dev.off()

pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_",label,"_count_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,".pdf"), width = 15, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_",label,"_feature_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,".pdf"), width = 15, height = 5)
#FeaturePlot(merged_obj, reduction = "umap", features="counts",split.by="slide") #+ NoLegend()
FeaturePlot(merged_obj[,merged_obj@meta.data$slide!="snRNA"], reduction = "umap", features="nFeature_Xenium",split.by="slide")
dev.off()

pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_",label,"_cellsize_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,".pdf"), width = 15, height = 5)
#FeaturePlot(merged_obj, reduction = "umap", features="counts",split.by="slide") #+ NoLegend()
