...
###########################
path0="20260415__201807__HY_ONH-PeriRet-RPE_20260415" #args[3]
kw="ONH0" #args[4]
cb_dir="/dfs3b/ruic20_lab/junw42/HCA_ON/data/8_spatial/Xenium/" #args[5]
id="6" #args[6]
wd=paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/8_spatial/Xenium/",od)
...
#########
 ...
 md=basename(normalizePath(matching_dirs_1[i]))
  ...
  xenium_data_list_2[[i]] <- xenium.obj
  names(xenium_data_list_2)[i] <- dir #unlist(strsplit(dir, split = "_"))[1]
  
}


#####################
xenium_data_list_comb=c(xenium_data_list, xenium_data_list_1, xenium_data_list_2)

saveRDS(xenium_data_list_comb, paste0(output_PATH, target_tissue, "_8_xenium_data_list_comb_cutoff20.rds"))
...
##############xenium.combined=readRDS(paste0(output_PATH, target_tissue, "_8_xenium.combined_cutoff20.rds"))
