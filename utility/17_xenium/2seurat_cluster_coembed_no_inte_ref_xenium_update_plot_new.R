...
pdf(paste0(output_PATH, target_tissue, "_8_xenium_umap_facet_ref_xenium_combined_inte_harmony_clu_1_2_ct_heatmap.pdf"), width = 7, height = 7)
heatmap(tb)
dev.off()
...
pdf(paste0(output_PATH, target_tissue, "_8_xenium_umap_facet_ref_xenium_combined_inte_harmony_slide_ct_anno_w1.pdf"), width = 20, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_8_xenium_umap_facet_ref_xenium_combined_inte_harmony_ident_ct_anno_w1.pdf"), width = 10, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_8_xenium_umap_facet_ref_xenium_combined_inte_harmony_clu_1_2_ct_anno_nFea5_w1.pdf"), width = 10, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_8_xenium_umap_facet_ref_xenium_combined_inte_harmony_majorclass_ct_anno_w1.pdf"), width = 10, height = 5)
DimPlot(merged_obj, reduction = "umap", group.by="majorclass", split.by="ident", label =TRUE) + NoLegend()
dev.off()



saveRDS(merged_obj, file=paste0(output_PATH, target_tissue, "_8_coembed.combined_inte_harmony_w1", ".rds"))
...
pdf(paste0(output_PATH, target_tissue, "_8_all_annot_majorclass_", slide_id, "_w1.pdf"), width = 50, height = 35)
