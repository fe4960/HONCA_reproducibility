...
#########
######fn=paste0(output_PATH, "/spacexr/",label,"_", t, "_", clu, "_RCTD_results_nonneuron",idx,".rds")
#######if(idx == "n"){
fn=paste0(output_PATH, "/",label,"_", t, "_subclass3_RCTD_results_nonneuron.rds")
########}
...
xenium_obj=xenium_obj[,grepl("ONHON1|ON$|ONHON2", xenium_obj@meta.data[,"rctd1"])]
...
#  saveRDS(RCTD, paste0(output_PATH, label,"_", t, "_", clu, "_RCTD_results_nonneuron.rds"))
  saveRDS(RCTD, paste0(output_PATH, label,"_", t, "_", clu, "_RCTD_results_nonneuron020_ONHON_ON.rds"))

#  saveRDS(RCTD, paste0(output_PATH, label,"_", t, "_", clu, "_RCTD_results_nonneuron020_ONHON.rds"))
#  saveRDS(RCTD, paste0(output_PATH, label,"_", t, "_", clu, "_RCTD_results_nonneuron_ONHON.rds"))
