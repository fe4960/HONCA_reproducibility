...
xenium_obj@meta.data$xenium_clusters_p2=x1@meta.data$xenium_clusters_p2
...
p=ImageDimPlot(object = xenium_obj, group.by = "xenium_clusters_p2", border.size = 0, cols = "Set2", axes=TRUE, dark.background=FALSE)
#+ theme(
...
fn=paste0(output_PATH, target_tissue,"_",label,"_cell_cluster_dist_y_comb.pdf")
