...
xenium.combined=readRDS(paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/8_spatial/Xenium/20250620_PP_comb/ONONH_comb/ONONH_combcoembed.combined_inte_harmony_astro_rpca_flt20_fc_5_BCM_22_0047_ON_ONH_RNA_ds_celltype2_slide_", slide_id, "_ONHON.rds"))
...
pdf(paste0(output_PATH, "/ONONH_combcoembed.combined_inte_harmony_astro_rpca_flt20_fc_5_celltype2_", slide_id, "_ONHON.pdf"), width = 50, height = 35)
