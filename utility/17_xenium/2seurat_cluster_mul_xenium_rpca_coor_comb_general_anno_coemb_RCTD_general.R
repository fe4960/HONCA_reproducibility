...
#pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_",sc,"_",slide_id,"_cutoff",cut,"_fc_",fc,"_",clu,"_only.pdf"), width = 50, height = 35)
#p=ImageDimPlot(object = xenium_obj, group.by = clu, border.size = 0,  axes=TRUE, dark.background=TRUE, cols = "polychrome", border.color=NA)
#print(p)
#dev.off()


##########pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_",sc,"_",slide_id,"_cutoff",cut,"_fc_",fc,"_rctd1_only1.pdf"), width = 22, height = 12)
###########p=ImageDimPlot(object = xenium_obj,  group.by = "rctd1", border.size = 0,  axes=TRUE, dark.background=FALSE,  border.color=NA, cols = "Set1", alpha = 1)+theme_bw()+theme_minimal(base_size=25) #, crop=TRUE, overlap=TRUE,  alpha=1)

########print(p)
##########dev.off()

######pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_",sc,"_",slide_id,"_cutoff",cut,"_fc_",fc,"_rctd1_only1_dark_set2.pdf"), width = 22, height = 12)
######p=ImageDimPlot(object = xenium_obj,  group.by = "rctd1", border.size = 0,  axes=TRUE, dark.background=TRUE,  border.color=NA, cols = "Set2") #, crop=TRUE, overlap=TRUE,  alpha=1)
######print(p)
######dev.off()


#######pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_",sc,"_",slide_id,"_cutoff",cut,"_fc_",fc,"_rctd1_only1_dark_set1.pdf"), width = 22, height = 12)
######p=ImageDimPlot(object = xenium_obj,  group.by = "rctd1", border.size = 0,  axes=TRUE, dark.background=TRUE,  border.color=NA, cols = "Set1") #, crop=TRUE, overlap=TRUE,  alpha=1)
#####print(p)
######dev.off()


######pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_",sc,"_",slide_id,"_cutoff",cut,"_fc_",fc,"_rctd1_only1_dark_set3.pdf"), width = 22, height = 12)
######p=ImageDimPlot(object = xenium_obj,  group.by = "rctd1", border.size = 0,  axes=TRUE, dark.background=TRUE,  border.color=NA, cols = "Set3") #, crop=TRUE, overlap=TRUE,  alpha=1)
#######print(p)
######dev.off()

######pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_",sc,"_",slide_id,"_cutoff",cut,"_fc_",fc,"_rctd1_only1_dark_dark2.pdf"), width = 22, height = 12)
######p=ImageDimPlot(object = xenium_obj,  group.by = "rctd1", border.size = 0,  axes=TRUE, dark.background=TRUE,  border.color=NA, cols = "Dark2") #, crop=TRUE, overlap=TRUE,  alpha=1)
######print(p)
#######dev.off()

#######pdf(paste0(output_PATH, target_tissue, "_",label,"_annot_",sc,"_",slide_id,"_cutoff",cut,"_fc_",fc,"_rctd1_only1_dark_accent.pdf"), width = 22, height = 12)
#######p=ImageDimPlot(object = xenium_obj,  group.by = "rctd1", border.size = 0,  axes=TRUE, dark.background=TRUE,  border.color=NA, cols = "Accent") #, crop=TRUE, overlap=TRUE,  alpha=1)
######print(p)
#######dev.off()
...
#######p=ImageDimPlot(object = xenium_obj,  group.by = "rctd1", border.size = 0,  axes=TRUE, dark.background=TRUE,  border.color=NA, cols = c("purple1",  "yellow" )) # oligo #, crop=TRUE, overlap=TRUE,  alpha=1)
