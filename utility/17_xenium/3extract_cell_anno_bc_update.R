...
write.table(oligo,file=paste0(output_PATH, target_tissue, "_xenium_w1_6_",id,"_oligo"))
...
write.table(fibro,file=paste0(output_PATH, target_tissue, "_xenium_w1_6_",id,"_fibro"))
...
write.table(astro,file=paste0(output_PATH, target_tissue, "_xenium_w1_6_",id,"_astro"))
...
write.table(astro,file=paste0(output_PATH, target_tissue, "_xenium_w1_6_",id,"_endo"))
