...
adata_ref.obs["celltype1"]=[ x.split("_")[0]+"_"+ x.split("_")[1] for x in adata_ref.obs["celltype"]  ]



adata_ref.obs["system"]="snRNA"
adata_ref.obs["ident"]="ref"
adata_ref.obs["barcode"]=adata_ref.obs.index
sample=[]
...
sc.pl.umap(adata, color="celltype", title="celltype", save=f"_{label}_pca_ct_harmony.png", frameon=False )
sc.pl.umap(adata, color="sampleid", title="sampleid", save=f"_{label}_pca_ct_sampleid.png", frameon=False )
sc.pl.umap(adata, color="celltype1", title="celltype1", save=f"_{label}_pca_ct_harmony.png", frameon=False )

adata.write(f"{outdir}/{label}_sn_st_scvi_harmony.h5ad")
