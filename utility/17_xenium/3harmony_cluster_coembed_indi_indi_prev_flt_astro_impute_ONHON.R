...
ref.combined=ref.combined[,grepl("ONHON1|ON$|ONHON2", ref.combined@meta.data[,"celltype2"])]
...
xenium.combined=readRDS(paste0(outdir, "/", t, "_integrated_merFISH.rds"))

###########
fn=paste0(output_PATH, "/spacexr/",label,"_", t, "_subclass3_RCTD_results_nonneuron.rds")
########}
#RCTD=readRDS(paste0(output_PATH, "/spacexr/",label,"_", slide_id,"_",sc, "_RCTD_results_nonneuron.rds"))
RCTD=readRDS(fn)
#xenium_obj=xenium.combined[,rownames(RCTD@results$results_df)]
xenium_obj=subset(xenium.combined, subset = (barcode %in% rownames(RCTD@results$results_df)))
#RCTD=readRDS(fn)

xenium_obj@meta.data[,"rctd1"]=RCTD@results$results_df[xenium_obj@meta.data$barcode,]$first_type
xenium_obj@meta.data[,"rctd2"]=RCTD@results$results_df[xenium_obj@meta.data$barcode,]$second_type
xenium_obj@meta.data[,"spot_class"]=RCTD@results$results_df[xenium_obj@meta.data$barcode,]$spot_class

xenium_obj=xenium_obj[,xenium_obj@meta.data[,"rctd1"]!="NA"]
xenium_obj=xenium_obj[,xenium_obj@meta.data$spot_class=="singlet"]

xenium_obj=xenium_obj[,grepl("ON$|ONHON", xenium_obj@meta.data[,"rctd1"])]


xenium.combined=xenium_obj
...
pdf(paste0(output_PATH, target_tissue, "coembed.combined_harmony_umap_",label, "_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,"_slide_",t,"_ONHON.pdf"), width = 12, height = 5)
...
saveRDS(merged_obj, paste0(output_PATH, target_tissue, "coembed.combined_inte_harmony_",label, "_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,"_slide_",t,"_ONHON.rds"))

merged_obj=readRDS(paste0(output_PATH, target_tissue, "coembed.combined_inte_harmony_",label, "_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,"_slide_",t,"_ONHON.rds"))

pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_",label,"_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,"_slide_",t,"_ONHON.pdf"), width = 5, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_sampleid_",label,"_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,"_slide_",t,"_ONHON.pdf"), width = 5, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_slide_",label,"_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,"_slide_",t,"_ONHON.pdf"), width = 15, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_heatmap_",label,"_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,"_slide_",t,"_ONHON.pdf"), width = 7, height = 7)
heatmap(tb)
dev.off()
...
#####
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_",label,"_anno_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,"_slide_",t,"_ONHON.pdf"), width = 15, height = 5)
DimPlot(merged_obj, reduction = "umap", group.by="harmony_anno",label=F,split.by="slide") #+ NoLegend()
dev.off()

pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_",label,"_subclass_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,"_slide_",t,"_ONHON.pdf"), width = 15, height = 5)
DimPlot(merged_obj, reduction = "umap", group.by=sc,label=F,split.by="slide") #+ NoLegend()
dev.off()

pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_",label,"_count_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,"_slide_",t,"_ONHON.pdf"), width = 15, height = 5)
...
pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_",label,"_feature_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,"_slide_",t,"_ONHON.pdf"), width = 15, height = 5)
#FeaturePlot(merged_obj, reduction = "umap", features="counts",split.by="slide") #+ NoLegend()
FeaturePlot(merged_obj[,merged_obj@meta.data$slide!="snRNA"], reduction = "umap", features="nFeature_Xenium",split.by="slide")
dev.off()

pdf(paste0(output_PATH, target_tissue, "_xenium_umap_facet_ref_xenium_combined_inte_harmony_ct_",label,"_cellsize_rpca_flt",cut,"_fc_",fc,"_",sam,"_",sc,"_slide_",t,"_ONHON.pdf"), width = 15, height = 5)
#FeaturePlot(merged_obj, reduction = "umap", features="counts",split.by="slide") #+ NoLegend()
