...
known_markers={"Rod": ["Cngb1","Nt5e","Pde6a","Reep6","Susd3"], "Cone": ["Adrb1", "Casp7", "Cngb3", "Kcne2", "Pde6c"], "AC": ["Gad2", "Pax6", "Slc32a1","Slc6a1", "Slc6a9","Tfap2a"], "RBC": ["Prkca","Strip2","Tpbg","Vstm2b"], 'BC': ["Crx","Grik1","Grm6","Isl1","Otx2","Vsx1","Vsx2"], 'RGC': ["Pou4f1","Pou4f2","Rbpms","Slc17a6"], 'HC': ["Adra2a", "Lhx1", "Lima1", "Onecut1", "Onecut2"], 'MG':["Id3","Kcnj10","Kdr","Rdh10","Vim"]}
