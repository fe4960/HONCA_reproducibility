...
if label_key == "none":
	scvi.model.SCVI.setup_anndata(adata_query, batch_key = batch_key, layer="counts", categorical_covariate_keys=covar)
#	scvi.data.setup_anndata(adata_query, batch_key = batch_key)
else:
	scvi.model.SCVI.setup_anndata(adata_query, batch_key = batch_key, layer="counts" , labels_key = label_key, categorical_covariate_keys=covar)
