...
#query=${main}/HCA_ON/data/scvi/RNA/raw/${celltype}.h5ad
query=${main}/HCA_ON/data/9_Brain_h5ad/GSE167494_more/${celltype}.h5ad

#query=${main}/HCA_ON/data/9_Brain_h5ad/GSE167494/${celltype}.h5ad
#query=${main}/HCA_ON/data/9_Brain_h5ad/${celltype}.h5ad

batch_key="sampleid"

bname="${celltype}_hvg_${hvg}_epoch_${max_epoch}_${fl}_rs_${res}_sb"


label_key="none"
#outdir=${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/
#outdir=${main}/HCA_ON/data/scvi/RNA/raw/${celltype}
outdir=${main}/HCA_ON/data/9_Brain_h5ad/${celltype}
