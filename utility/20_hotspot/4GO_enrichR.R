...
data=read.table(paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/20_hotspot/",ct,"_hs_gene_module_assignment_min_gene_",label,"_",t,".csv"),header=T,sep=",")
...
dirIn=paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/20_hotspot/",ct,"_hs_min_gene_",label,"_",t,"_m_",m, "_bg")

}else{
if (websiteLive) {
    enriched2 <- enrichr(geneList_up, dbs)
}
dirIn=paste0("/dfs3b/ruic20_lab/junw42/HCA_ON/data/20_hotspot/",ct,"_hs_min_gene_",label,"_",t,"_m_",m,"_nobackground")
...
pdf(paste0("MSigDB_Hallmark_2020","_",ct,"_",label,"_",t,"_m_",m,".pdf"))
print(p)
dev.off()
