...
#bname="${celltype}_hvg${hvg}_epoch${max_epoch}_${fl}_rs_${res}_subclass"
bname=$2

python /dfs3b/ruic20_lab/junw42/HCA_ON/scripts/5_refine_major/13subclass_umap.py $outdir $bname  
