...
gl="zinb"
span=1
kp="kp_cluster_rs_4_5"  #none
query=${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_subclass_LC_other1.h5ad
batch_key="sampleid"
...
obs=${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_hvg10000_epochnone_seurat_v3_res_0.6_clean_rm4_sb_res_0.6.obs.gz
#obs="none"
item="leiden" #"none"
ntrg=10
mk="sanes_mk"
