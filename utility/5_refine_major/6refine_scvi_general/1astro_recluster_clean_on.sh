...
bname=${celltype}_hvg${hvg}_epoch${max_epoch}_seurat_rs_${res}_clean_sb_rm0_12_15_16_${kp}_seed_${seed}
...
#obs="none"
obs_rm=${main}/HCA_ON/data/5_refine_major/scvi/${celltype}/clean/${celltype}_hvg10000_epochnone_seurat_rs_1_clean_sb_none.obs.gz
