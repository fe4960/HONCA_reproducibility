...
query=/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/ON_ONH_clean_new_update_final.h5ad
batch_key="sampleid"
...
bname="${celltype}_hvg${hvg}_epoch${max_epoch}_${fl}_rs_${res}_subclass_sb_seurat_rmRPE_ret"
