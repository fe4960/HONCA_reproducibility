...
bname=f"{celltype}_subclass_clean_new_rename_rmRPE_seurat1"

#bname=f"{celltype}_subclass"
adata.obs["subclass"]="Fibroblast"
sc.settings.figdir = f"{outdir}/figures"

adata1=sc.read_h5ad(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_rs_1_clean_sb_none_seed_7_rmRPE_scvi_trg.h5ad")
...
obs=pd.read_csv(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_rs_0.9_clean_sb_none_seed_7_rmRPE.obs.gz",header=0,index_col=0)
...
adata=adata[-adata.obs["leiden"].isin(["11","13","14", "15"])]

dt={"0":"Fibro_pia" ,"12":"Fibro_pia" ,"8": "Fibro_perivascular","6":"Fibro_RPEchoroid_BMP5+", "1":"Fibro_arachnoid","5":"Fibro_arachnoid_TRPM3+","9":"Fibro_arachnoid_STXBP6+","3": "Fibro_dura_SLC47A1+","4":"Fibro_dura", "2": "Fibro_sclera", "10":"Fibro_x", "7": "Fibro_HMCN1+"}
...
dt1={"0":"Fibro_pia" ,"12":"Fibro_pia" ,"8": "Fibro_perivascular","6":"Fibro_RPEchoroid", "1":"Fibro_arachnoid","5":"Fibro_arachnoid","9":"Fibro_arachnoid","3": "Fibro_dura","4":"Fibro_dura", "2": "Fibro_sclera", "10":"Fibro_x", "7": "Fibro_arachnoid"}
