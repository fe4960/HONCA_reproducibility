...
#adata=sc.read_h5ad(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_v3_rs_0.4_clean_rm4_15_16_scvi_trg.h5ad")
#adata=sc.read_h5ad(f"{outdir}/Oligodendrocyte_hvg10000_epochnone_seurat_v3_rs_0.4_clean_rm4_15_scvi_trg.h5ad")
adata1=sc.read_h5ad(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_rs_0.4_clean_rm4_15_sb_none_scvi_trg.h5ad")
#adata=sc.read_h5ad(f"{outdir}/{celltype}_subclass_new.h5ad")
adata=sc.read_h5ad(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_v3_rs_0.4_clean_rm4_15_scvi_trg.h5ad")
bname=f"{celltype}_subclass_seurat_rmRPE"

#bname=f"{celltype}_subclass_seurat"
#adata.obs["leiden1"]="Oligodendrocyte"

adata.obs["subclass"]="Oligodendrocyte"
sc.settings.figdir = f"{outdir}/figures"
#obs=pd.read_csv(f"{outdir}/{celltype}_res_0.3_clean_rm_res_0.3.obs.gz",header=0, index_col=0)
...
obs=pd.read_csv(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_rs_0.6_clean_rm4_15_sb_none.obs.gz", index_col=0,header=0)
adata.obs["leiden"]=obs.loc[adata.obs.index,"leiden"].astype("str").astype("category")
#dt={"2": f"OLIGO_SVEP1-hi", "1": f"OLIGO_LRRC7-hi", "0": f"OLIGO_RBFOX1-hi",  "3": f"OLIGO_non_specific", "4": f"OLIGO_NAV2-hi"}
#dt={"0": "OLIGO_LRRC7+", "1": "OLIGO_non_specific","2": "OLIGO_SVEP1+", "3": "OLIGO_RBFOX1+", "4": "OLIGO_SVEP1+", "5" : "OLIGO_non_specific", "6": "OLIGO_SVEP1+"}
dt={"0": "OLIGO2_LRRC7+", "1": "OLIGO1","2": "OLIGO1_SVEP1+", "3": "OLIGO1_RBFOX1+", "4": "OLIGO1_SVEP1+", "5" : "OLIGO1", "6": "OLIGO1_SVEP1+"}
...
#adata.obs["leiden1"]=adata.obs["leiden1"].astype("str")
...
sc.pl.embedding(adata, basis="X_umap", color=["subclass"],legend_loc="on data", ncols=1,frameon=False,save=f'{bname}.png', palette="tab20")
...
plot=["race", "gender", "age_year", "subclass"]
