...
query="/dfs3b/ruic20_lab/junw42/HCA_ON/data/5_refine_major/scvi/Astrocyte/clean/Astrocyte_seed_7_res_0.4_clean_ononh_retina_scvi_trg_rm_clu10.h5ad"
batch_key="sampleid"
...
bname="${celltype}_hvg_${hvg}_fl_${fl}_res_${res}_sd_${seed}_ononh_retina_nonsb"
