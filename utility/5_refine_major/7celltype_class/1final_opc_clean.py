...
adata1=sc.read_h5ad(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_v3_rs_0.3_clean_res0.3rm1_sb_none_scvi_trg.h5ad")
...
dt={"0": f"{celltype1}", "1": f"{celltype1}_GLIS3+", "2": f"MFOL", "3": f"COP_NFOL", "4": f"COP_LAMA2+"}
