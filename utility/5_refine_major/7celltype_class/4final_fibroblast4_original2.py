...
bname=f"{celltype}_subclass_clean_new_rename_rmRPE_seurat_v3_rename_location1"

#bname=f"{celltype}_subclass_clean_new_rename_rmRPE_seurat_v3_rename_location"
#bname=f"{celltype}_subclass_clean_new_rename_rmRPE_seurat_v3_recluster"

#bname=f"{celltype}_subclass"
adata.obs["subclass"]="Fibroblast"
sc.settings.figdir = f"{outdir}/figures"

adata1=sc.read_h5ad(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_v3_rs_1_clean_sb_none_seed_7_rmRPE_scvi_trg.h5ad")
...
obs=pd.read_csv(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_v3_rs_0.9_clean_sb_none_seed_7_rmRPE.obs.gz",header=0,index_col=0)
...
#dt={"0":"Fibro_Pia" ,"12":"Fibro_arachnoid_PLCB4+" ,"13": "Fibro_arachnoid_PLCB4+","11":"Fibro_dura","2":"Fibro_dura","6":"Fibro_RPEchoroid_SMOC2+","8":"Fibro_perivascular","1":"Fibro_pia_ABCA10+","10":"Fibro_pia_ABCA10+","7": "Fibro_HMCN1+","4":"Fibro_RPEchoroid_BMP5+","3":"Fibro_sclera_NOX4+","5":"Fibro_sclera_KCNMA1+","9":"Fibro_x"}

adata=adata[-adata.obs["leiden"].isin(["11","12","14"])]
############dt={"0":"Fibro_intima_pia" ,"13":"Fibro_intima_pia" ,"8": "Fibro_epipial","6":"Fibro_RPEchoroid_BMP5+","7":"Fibro_dura_NOX4+","3":"Fibro_dura_KCNMA1+","1":"Fibro_dura_boarder_SLC47A1+","5":"Fibro_arachnoid_barrier_STXBP6+","2":"Fibro_arachnoid_CLDN11+","4": "Fibro_arachnoid_TRPM3+","10":"Fibro_x", "9": "Fibro_arachnoid_trabeculae_HMCN1+"}

dt={"0":"Fibro_pia_ABCA10+" ,"13":"Fibro_pia_ABCA10+" ,"8": "Fibro_ATP10A+","6":"Fibro_RPEchoroid_BMP5+","7":"Fibro_sclera_dura_NOX4+","3":"Fibro_sclera_dura_KCNMA1+","1":"Fibro_dura_SLC47A1+","5":"Fibro_STXBP6+","2":"Fibro_arachnoid_CLDN11+","4": "Fibro_arachnoid_TRPM3+","10":"Fibro_x", "9": "Fibro_HMCN1+"}



#######dt={"0":"Fibro_pia" ,"13":"Fibro_pia" ,"8": "Fibro_perivascular","6":"Fibro_RPEchoroid_BMP5+","7":"Fibro_sclera_NOX4+","3":"Fibro_sclera_KCNMA1+","10":"Fibro_x", "9": "Fibro_HMCN1+"}

#######obs1=pd.read_csv(f"{outdir}/{celltype}_hvg10000_epochnone_seurat_v3_rs_0.3_clean_sb_kp_cluster_more_seed_7_rmRPE.obs.gz",header=0,index_col=0)

#idx1=obs1.loc[obs1["leiden"].isin([0])].index.intersection(adata.obs.index)
#idx2=obs1.loc[obs1["leiden"].isin([1])].index.intersection(adata.obs.index)
#idx3=obs1.loc[obs1["leiden"].isin([2])].index.intersection(adata.obs.index)
#idx4=obs1.loc[obs1["leiden"].isin([0])].index.intersection(adata.obs.index)
...
#adata.obs.loc[idx1,"subclass"]="Fibro_arachnoid_TRPM3+"
#adata.obs.loc[idx2,"subclass"]="Fibro_dura_SLIT2"
#adata.obs.loc[idx3, "subclass"]="Fibro_arachnoid_CASC15+"

#adata=adata[-adata.obs["subclass"].isin(["5"])]

dt1={"0":"Fibro_pia", "13":"Fibro_pia" ,"8": "Fibro_ATP10A+","6":"Fibro_RPEchoroid","7":"Fibro_sclera_dura","3":"Fibro_sclera_dura","1":"Fibro_dura","5":"Fibro_STXBP6+","2":"Fibro_arachnoid","4": "Fibro_arachnoid","10":"Fibro_x", "9": "Fibro_HMCN1+"}


#dt1={"0":"Fibro_pia" ,"13":"Fibro_pia" ,"8": "Fibro_perivascular","6":"Fibro_RPEchoroid","7":"Fibro_sclera","3":"Fibro_sclera","1":"Fibro_dura","5":"Fibro_arachnoid","2":"Fibro_arachnoid","4": "Fibro_arachnoid","10":"Fibro_x", "9": "Fibro_HMCN1+"}
#dt1={"0":"Fibro_pia" ,"13":"Fibro_pia" ,"8": "Fibro_perivascular","6":"Fibro_RPEchoroid","7":"Fibro_sclera","3":"Fibro_sclera","10":"Fibro_x", "9": "Fibro_HMCN1+"}


adata.obs["subclass1"]=adata.obs["leiden"].replace(dt1)

#adata.obs.loc[idx1,"subclass1"]="Fibro_arachnoid"
#adata.obs.loc[idx2,"subclass1"]="Fibro_dura"
#adata.obs.loc[idx3, "subclass1"]="Fibro_arachnoid"
