...
adata=sc.read_h5ad(f"{outdir}/{celltype}_subclass_new_rm_non_spec.h5ad")
adata1=sc.read_h5ad(f"{outdir}/{celltype}_subclass_new_rm_non_spec_onh_hvg10000_epochnone_seurat_v3_rs_0.4_clean_sb_scvi_trg.h5ad")
...
bname=f"{celltype}_subclass_new_clean"
...
dt={"2": f"OLIGO_SVEP1-hi", "1": f"OLIGO_LRRC7-hi", "0": f"OLIGO_RBFOX1-hi", "3": f"OLIGO_NAV2-hi"}
