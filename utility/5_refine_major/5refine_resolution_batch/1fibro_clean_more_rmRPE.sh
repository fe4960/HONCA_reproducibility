...
h5ad=${outdir}/${cell}_hvg10000_epochnone_seurat_v3_rs_1_clean_sb_none_seed_7_rmRPE_scvi_trg.h5ad

#bname=${cell}_hvg10000_epochnone_seurat_rs_${res}_clean_sb_none_seed_7_rmRPE
bname=${cell}_hvg10000_epochnone_seurat_v3_rs_${res}_clean_sb_none_seed_7_rmRPE
