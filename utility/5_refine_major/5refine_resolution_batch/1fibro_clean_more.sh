...
for res in 0.5 0.6 0.7 0.8 1.2
do
...
h5ad=${outdir}/${cell}_hvg10000_epochnone_seurat_rs_1_clean_sb_none_rm1_11_16_seed_7_scvi_trg.h5ad

bname=${cell}_hvg10000_epochnone_seurat_rs_${res}_clean_sb_none_rm1_11_16_seed_7
