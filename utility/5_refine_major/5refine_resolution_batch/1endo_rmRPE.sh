...
h5ad=${outdir}/${cell}_hvg10000_epochnone_seurat_rs_0.6_subclass_sb_seurat_rmRPE_scvi_trg.h5ad
#bname=${cell}_hvg10000_epochnone_seurat_rs_${res}_clean_rm_sb_rm_4_6_none_scvi_trg.h5ad
bname=${cell}_hvg10000_epochnone_seurat_rs_${res}_subclass_sb_seurat_rmRPE
