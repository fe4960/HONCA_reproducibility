...
#mk="sanes_mk"
sbatch -p free --mem=30GB --time=0-2 --error=${err}/${bname}.err --output=${err}/${bname}.out --account=ruic20_lab /dfs3b/ruic20_lab/junw42/HCA_ON/scripts/5_refine_major/6refine_scvi_plot_MALAT1.sh $indir  $bname
done
#done < $file
